...
Panel plugin for [DTCD](https://github.com/ISGNeuroTeam/DTCD) application designed to display some data in a custom list view.
...
```
tar -zxf DTCD-Visualization-List-*.tar.gz ./DTCD-Visualization-List
```
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/ISGNeuroTeam/DTCD-Visualization-List/tags).
